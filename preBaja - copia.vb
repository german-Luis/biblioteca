...
Public Class preBaja
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim leer As New StreamReader("C:\Users\gcruz\source\repos\examen\prestamo.txt")
        Dim datos As String = ""
        While leer.Peek <> -1
        ...
        leer.Close()
        escribir.Close()
        My.Computer.FileSystem.DeleteFile("C:\Users\gcruz\source\repos\examen\prestamo.txt")
        My.Computer.FileSystem.RenameFile("C:\Users\gcruz\source\repos\examen\aux.txt", "prestamo.txt")
        TextBox1.Text = ""
        TextBox2.Text = ""
        TextBox3.Text = ""
        TextBox4.Text = ""
